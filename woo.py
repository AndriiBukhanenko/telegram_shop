...
store_url = 'http://www.erborian.com.ua'
endpoint = '/wc-auth/v1/authorize'
params = {
    "app_name": "ErborianDev",
    "scope": "read_write",
    "user_id": 123,
...
# wcapi = API(
#     url="http://www.parfumburo.ua/",
#     consumer_key="ck_556997aa443f121bace03489a4c83278101b6d51",
#     consumer_secret="cs_d1cdb87c0f44aca15bfcbd620bd1974fb7e0fb97",
#     query_string_auth=True,
#     version="wc/v3"
# )

wcapi = API(
    url="http://www.erborian.com.ua/",
    consumer_key="ck_b692513e0be0f8226d4f6f9e1ad09054641b75ec",
    consumer_secret="cs_456e19e23eb46bf8a8326d8c51d5a8f6af7ecde4",
    query_string_auth=True,
    version="wc/v3"
)
...
categories = wcapi.get("products/categories/", params=parameter).json()
see =1
...
def push_products():
    ...
    sheet = wb.get_sheet_by_name('ERBORIAN')
    ...
    for i in range(2, 5 + 1):
         ...
         brand = str(sheet.cell(row=i, column=10).value)
...
# print('Parfums d’Orsay' == 'Parfums d’Orsay')



def update_products():
    wb = load_workbook('./inf.xlsx')
    ...
    for page in range(6, 11):
        ...
        parameter["per_page"] = 100
        parameter['page'] = page
        products = wcapi.get("products/", params=parameter).json()

        for product in products:
            for i in range(2, 1025):
                sku = sheet.cell(row=i, column=1).value
                inf = sheet.cell(row=i, column=10).value
